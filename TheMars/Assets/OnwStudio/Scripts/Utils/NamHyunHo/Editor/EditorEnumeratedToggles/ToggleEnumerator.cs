...
namespace EditorTool
{
    public sealed class ToggleEnumerator<T>
    {
        ...
        public void InitializeGUIStyle(Color32 selectedStyleColor, Color32 defaultStyleColor)
        {
            ...
            _selectedGUIStyle.normal.background = EditorTool.GetTexture2D(selectedStyleColor, _selectedGUIStyle);
            _defaultGUIStyle.normal.background = EditorTool.GetTexture2D(defaultStyleColor, _defaultGUIStyle);
        }
