...
namespace TM.Buff.Trigger
{
    ...
    public class TMCardCostAllModifyBuffTrigger : TMDelayBuffTrigger
    {
        ...
        {
            return ITMBuffTrigger.CreateBuff<TMCardCostAllModifyBuff, TMCardCostAllModifyBuffTrigger>(this);
        }
    }
}
