...
//        [InfoBox("효과의 설명 중 언어별 설정이 필요한 경우 추가되어야 합니다")]
//        [SerializeField, SerializedDictionary("Effect Description", "Description", true, isLocked: true), FormerlySerializedAs("_effectDescriptions"), DisplayAs("카드 효과 설명")]
//        private SerializedDictionary<string, NestedSerializedDictionary> _effectDescriptions = new();
...
//        [InfoBox("카드 중 커스텀 설명이 들어간 경우 국가별 언어로 설정해주어야 합니다")]
