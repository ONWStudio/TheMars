...
namespace TMCardUISystemModules
{
    ...
    public interface ICardSorter
    {
        ...
        void SortCards(List<TMCardUIController> cardUIs, RectTransform rectTransform, float duration);
        /// <summary>
        ...
        /// <param name="rectTransform"> .. 비율로 배치시키기 때문에 기준이 되는 렉트 트랜스폼을 인자값으로 넣어줍니다 </param> 
        void ArrangeCard(List<TMCardUIController> cardUIs, int index, RectTransform rectTransform, float duration);
    }
}