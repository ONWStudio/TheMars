...
namespace TM.Event
{
    ...
    public sealed class TMGovernanceSystemChangeEventData : TMEventData
    {
        ...
        [field: SerializeField, DisplayAs("획득 만족도"), OnwMin(0)] public int TopSatisfactionAddByDay { get; private set; } = 20;
        [field: SerializeField, DisplayAs("만족도 획득 일수"), OnwMin(0)] public int TopSatisfactionAddDayCount { get; private set; } = 2;
