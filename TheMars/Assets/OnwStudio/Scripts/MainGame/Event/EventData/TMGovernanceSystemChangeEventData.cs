...
namespace TM.Event
{
    public sealed class TMGovernanceSystemChangeEventData : TMEventData
    {
        ...
        [field: SerializeField, Range(0, 50), DisplayAs("소모 강철")] public int TopSteelSubtract { get; private set; } = 20;
        [field: SerializeField, Range(0, 50), DisplayAs("소모 크레딧")] public int TopCreditSubtract { get; private set; } = 30;
        [field: SerializeField, Range(10, 40), DisplayAs("획득 만족도")] public int TopSatisfactionAdd { get; private set; } = 20;

        [field: Header("기업과 얘기 해봐야겠군 선택지")]
        [field: SerializeField, Range(10, 60), DisplayAs("획득 크레딧")] public int BottomCreditAdd { get; private set; } = 40;
        [field: SerializeField, Range(10, 30), DisplayAs("획득 만족도")] public int BottomSatisfactionAdd { get; private set; } = 10;
