...
namespace TM.Event
{
    ...
    public abstract class TMEventData : ScriptableObject, ITMEventData
    {
        ...
        [field: SerializeField, LocalizedString, DisplayAs("[로컬라이징] 이벤트 설명 텍스트")] public LocalizedString DescriptionTextEvent { get; private set; }
        [field: SerializeField, LocalizedString, DisplayAs("[로컬라이징] 위쪽 버튼 텍스트")] public LocalizedString TopButtonTextEvent { get; private set; }
        [field: SerializeField, LocalizedString, DisplayAs("[로컬라이징] 아래쪽 버튼 텍스트")] public LocalizedString BottomButtonTextEvent { get; private set; }
        [field: SerializeField, LocalizedString, DisplayAs("[로컬라이징] 타이틀 텍스트")] public LocalizedString TitleTextEvent { get; private set; }
        [field: SerializeField, LocalizedString, DisplayAs("[로컬라이징] 위쪽 선택지 효과 텍스트")] public LocalizedString TopEffectTextEvent { get; private set; }
        [field: SerializeField, LocalizedString, DisplayAs("[로컬라이징] 아래쪽 선택지 효과 텍스트")] public LocalizedString BottomEffectTextEvent { get; private set; }
