...
namespace TMCard.Effect
{
    ...
    {
        [SerializeReference, DisplayAs("버리기"), FormerlySerializedAs("_cardEffectCreators"), SerializeReferenceDropdown] private List<ITMNormalEffectCreator> _cardEffectCreators = new();
