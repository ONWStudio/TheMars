...
//         }
//
//         public override void ApplyEffect(TMCardModel model, ITMEffectTrigger trigger)
//         {
...
//             _holdEffects.ForEach(holdEffect => holdEffect?.ApplyEffect(model, this));
//
//             void onHoldEffectByFriendlyCard(TMCardModel usedCard)
//             {
//                 if (!model)
//                 {
...
//                 }
//
//                 if (model.OnField && _friendlyCard.GetInstanceID() == usedCard.CardData.GetInstanceID())
//                 {
