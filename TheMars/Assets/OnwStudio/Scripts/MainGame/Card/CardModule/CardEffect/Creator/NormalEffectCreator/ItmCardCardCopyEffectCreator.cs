...
namespace TMCard.Effect
{
    ...
    public sealed class ItmCardCardCopyEffectCreator : ITMCardNormalEffectCreator
    {
        ...
        {
            return CardEffectGenerator.CreateEffect<ItmCardCardCopyEffect, ItmCardCardCopyEffectCreator>(this);
        }
    }
}
