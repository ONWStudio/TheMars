...
namespace TMCard.Effect
{
    ...
    public sealed class RepeatCard : ITMCardSpecialEffect, IDescriptable, ILabel
    {
        ...
        private sealed class EffectInitialAmountPair
        {
            ...
            public EffectInitialAmountPair(List<TMCardResourceEffect> resourceEffects, List<ITMNormalEffect> normalEffects)
            {
                UseCount = 0;
