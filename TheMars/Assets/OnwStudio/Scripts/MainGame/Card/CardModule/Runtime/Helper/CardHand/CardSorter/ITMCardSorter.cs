...
namespace TMCard.Runtime
{
    ...
    {
        public TMCardModel Target { get; }
        public Vector3 Position { get; }
        public Vector3 Rotation { get; }

        public PositionRotationInfo(TMCardModel target, Vector3 position, Vector3 rotation)
        {
            Target = target;
            Position = position;
            Rotation = rotation;
    ...
    /// </summary>
    public interface ITMCardSorter
    {
        /// <summary>
        ...
        List<PositionRotationInfo> SortCards(List<TMCardModel> cards, RectTransform rectTransform);
        /// <summary>
        ...
        /// <param name="rectTransform"> .. 비율로 배치시키기 때문에 기준이 되는 렉트 트랜스폼을 인자값으로 넣어줍니다 </param> 
        PositionRotationInfo ArrangeCard(List<TMCardModel> cards, int index, RectTransform rectTransform);
    }
}